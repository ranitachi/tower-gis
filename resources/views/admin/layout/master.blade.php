    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="title-alert">Alert</h4>
        </div>
        <div class="modal-body" id="body-alert">
        </div>
        <div class="modal-footer" id="footer-alert">
          <button type="button" class="btn btn-primary" data-dismiss="modal" id="okalert">OK</button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="title-info">Information</h4>
          </div>
          <div class="modal-body" id="body-info">
          </div>
          <div class="modal-footer" id="footer-info">
