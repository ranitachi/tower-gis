...
<body class="no-skin">
		...
		<script src="<?php echo e(asset('js/dataTables.tableTools.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/dataTables.colVis.min.js')); ?>"></script>
		...
		<script src="<?php echo e(asset('js/jquery.autosize.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/jquery.inputlimiter.1.3.1.min.js')); ?>"></script>
		<!-- ace scripts -->
