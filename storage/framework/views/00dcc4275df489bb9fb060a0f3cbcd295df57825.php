<head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('font-awesome/4.2.0/css/font-awesome.min.css')); ?>" />

        <!-- page specific plugin styles -->

        <!-- text fonts -->
        <link rel="stylesheet" href="<?php echo e(asset('fonts/fonts.googleapis.com.css')); ?>" />
        ...
        <link rel="stylesheet" href="<?php echo e(asset('css/daterangepicker.min.css')); ?>" />
        <link rel="stylesheet" href="<?php echo e(asset('css/bootstrap-datetimepicker.min.css')); ?>" />
        <link rel="stylesheet" href="<?php echo e(asset('css/colorpicker.min.css')); ?>" />
        <!--[if lte IE 9]>
