<form class="form-horizontal" id="validation-form" method="get">
	<div class="form-group">
		...
		<div class="col-xs-12 col-sm-9">
			<div class="clearfix">
				<input type="text" name="nama_vendor" id="nama_vendor" class="col-xs-12 col-sm-5" value="<?php echo e($id!=-1 ? $d->nama_vendor : ''); ?>"/>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-xs-12 col-sm-9">
			<div class="clearfix">
				<input type="text" name="nama_pimpinan" id="nama_pimpinan" class="col-xs-12 col-sm-4" value="<?php echo e($id!=-1 ? $d->nama_pimpinan : ''); ?>"/>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-xs-12 col-sm-9">
			<div class="clearfix">
				<input type="text" name="telp" id="telp" class="col-xs-12 col-sm-2" value="<?php echo e($id!=-1 ? $d->telp : ''); ?>" />
			</div>
		</div>
	</div>
						...
						$.ajaxSetup({
				       	...
				       	bootbox.confirm({
								...
								callback: function(result) {
									...
									// if(id=='-1')
										var urll=APP_URL+'/vendor/simpan/<?php echo e($id); ?>';
									// else
